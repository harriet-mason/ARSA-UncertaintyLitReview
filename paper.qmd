...
Rather than trying to define uncertainty by looking at the mirriad of ways in which it *does* appear in an analysis, we may find it easier to look at where it *does not*.
...
While it is true that we can think of visualisations as containing implicit inferential properties, there are many potential inferences in any single visualization. 
This makes it a little difficult ensure uncertainty is always included.
...
This is of course complicated by the fact that human colour perception varies at an individual level: some individuals have been documented to have 4 different cones and can thus perceive a different range of colors; others have only two or one functioning cone and have colour deficiencies. 
