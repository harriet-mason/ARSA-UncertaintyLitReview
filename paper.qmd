...
The pixel map is not the best uncertainty visualisation, but it is trying to *replicate* the best uncertainty visualisation. The best uncertainty visualisation is probably the the raw data, to understand why, we need to understand what "uncertainty" actually is.


Uncertainty is not just variance, and 
