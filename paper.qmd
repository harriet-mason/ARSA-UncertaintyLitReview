...
Uncertainty visualisation is not only motivated by signal-suppression, and we would be remiss to ignore these alternative motivations. In this section we discuss alternative motivations for uncertainty visualization, and explain why they are not the focus of this review.

## Uncertainty as a variable of interest
...
This is why text representations or graphics that allow users to simply count a value to extract the required statistic outperform those that require any perceptual tasks.



## Uncertainty for decision making
Some authors claim the purpose of uncertainty is to improve decision making [@Ibrekk1987; @uncertchap2022; @Hullman2016; @Cheong2016; @Boone2018; @Padilla2017]. This group are *also* viewing uncertainty as a signal, although it is less obvious in this case. 
...
This obfuscation problem translates to unanswerable questions in uncertainty evaluation experiments.

If we create a problem by obfuscating information, then the representation that makes the obfuscated information easiest to extract outperforms those that don't. 
...
## Uncertainty disappears if you stare directly at it
