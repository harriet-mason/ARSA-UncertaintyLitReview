...
- simplifying a multui-outcome array to two outcomes improved understanding @Spiegelhalter2017
...
- He then went through and explained how uncertainty is communicated across a wide range of areas @Spiegelhalter2017
...
Most definitions of uncertainty are done with a taxonomy. Most papers that provide a definition of uncert Within the context of a motivating uncertainty can be classified and  
...
## 4.?? Importance (and unimportance) of Meta information
...
# 4.?? Required Changes and Considerations to the Experimental Space 
